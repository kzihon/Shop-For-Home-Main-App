...
@RestController
@RequestMapping("/api/v1/main/customer")
...
public class CustomerController {
  ...
  public ResponseEntity<User> updateCustomer(@PathVariable long id,
          @RequestBody UpdateUser updateUser) {
       User user= customerService.updateCustomer(id, updateUser);
  ...
  public ResponseEntity<String> deleteFromWishList(@PathVariable long customer_id, @PathVariable long property_id) {

    try {
      customerService.removeFromWishList(customer_id, property_id);
