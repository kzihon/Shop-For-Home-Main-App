...
public class ProductService {
    private final String FOLDER_PATH = "/Users/kidist/Downloads/Shop-for-Home-Backend/images/";
    ...
    public Product updateProduct(long product_id, Product p, MultipartFile file) throws IOException {
        String filePath = FOLDER_PATH + file.getOriginalFilename();
...
//    public ResponseEntity<Product> updateProduct1(Long id, ProductRequest updatedProductRequest) throws IOException {
...
//                .name(updatedProductRequest.getName())
//                .price(updatedProductRequest.getPrice())
//                .description(updatedProductRequest.getDescription())
//                .category(updatedProductRequest.getCategory())
//                .numberInStock(updatedProductRequest.getNumberInStock())
//                .supplier(updatedProductRequest.getSupplier())
//                .build();
//
